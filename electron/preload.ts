...
const api: EqlApi = {
  ...
  wiki: {
    ...
    cachedSpells: () => ipcRenderer.invoke(CH.wikiCachedSpells),
    ...
    spellHarvestStart: (opts) => ipcRenderer.invoke(CH.wikiSpellHarvestStart, opts),
    spellHarvestStop: () => ipcRenderer.invoke(CH.wikiSpellHarvestStop),
    spellHarvestStatus: () => ipcRenderer.invoke(CH.wikiSpellHarvestStatus),
    onSpellHarvest: (cb) => on(CH.wikiSpellHarvestProgress, cb),
  },
  lucy: {
